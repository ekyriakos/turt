...
#include <stddef.h>
#include "turtle_interfaces/msg/detail/mission_status__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  turtle_interfaces__msg__MissionStatus__init(message_memory);
}

void MissionStatus__rosidl_typesupport_introspection_c__MissionStatus_fini_function(void * message_memory)
{
  turtle_interfaces__msg__MissionStatus__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember MissionStatus__rosidl_typesupport_introspection_c__MissionStatus_message_member_array[1] = {
  {
    "mission_status",  // name
    ...
    offsetof(turtle_interfaces__msg__MissionStatus, mission_status),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers MissionStatus__rosidl_typesupport_introspection_c__MissionStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(turtle_interfaces__msg__MissionStatus),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_interfaces, msg, MissionStatus)() {
