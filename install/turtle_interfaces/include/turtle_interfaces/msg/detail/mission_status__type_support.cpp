...
{
  new (message_memory) turtle_interfaces::msg::MissionStatus(_init);
}

void MissionStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtle_interfaces::msg::MissionStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MissionStatus_message_member_array[1] = {
  {
    ...
    offsetof(turtle_interfaces::msg::MissionStatus, mission_status),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MissionStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(turtle_interfaces::msg::MissionStatus),
...
{
  return &::turtle_interfaces::msg::rosidl_typesupport_introspection_cpp::MissionStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_interfaces, msg, MissionStatus)() {
  return &::turtle_interfaces::msg::rosidl_typesupport_introspection_cpp::MissionStatus_message_type_support_handle;
}
