...
#include <stddef.h>
#include "turtle_interfaces/msg/detail/mission__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  turtle_interfaces__msg__Mission__init(message_memory);
}

void Mission__rosidl_typesupport_introspection_c__Mission_fini_function(void * message_memory)
{
  turtle_interfaces__msg__Mission__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Mission__rosidl_typesupport_introspection_c__Mission_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(turtle_interfaces__msg__Mission, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtle_interfaces__msg__Mission, mission),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Mission__rosidl_typesupport_introspection_c__Mission_message_members = {
  ...
  2,  // number of fields
  sizeof(turtle_interfaces__msg__Mission),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_interfaces, msg, Mission)() {
