...
{
  new (message_memory) turtle_interfaces::msg::Steering(_init);
}

void Steering_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtle_interfaces::msg::Steering *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Steering_message_member_array[2] = {
  {
    ...
    offsetof(turtle_interfaces::msg::Steering, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtle_interfaces::msg::Steering, steering),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Steering_message_members = {
  ...
  2,  // number of fields
  sizeof(turtle_interfaces::msg::Steering),
...
{
  return &::turtle_interfaces::msg::rosidl_typesupport_introspection_cpp::Steering_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_interfaces, msg, Steering)() {
  return &::turtle_interfaces::msg::rosidl_typesupport_introspection_cpp::Steering_message_type_support_handle;
}
