...
turtle_interfaces__msg__VnUtcTime__init(turtle_interfaces__msg__VnUtcTime * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    turtle_interfaces__msg__VnUtcTime__fini(msg);
    return false;
  }
  // time_stamp
  return true;
...
{
  turtle_interfaces__msg__VnUtcTime * msg = (turtle_interfaces__msg__VnUtcTime *)malloc(sizeof(turtle_interfaces__msg__VnUtcTime));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(turtle_interfaces__msg__VnUtcTime));
  bool success = turtle_interfaces__msg__VnUtcTime__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
turtle_interfaces__msg__VnUtcTime__Sequence__init(turtle_interfaces__msg__VnUtcTime__Sequence * array, size_t size)
{
  ...
  turtle_interfaces__msg__VnUtcTime * data = NULL;
  if (size) {
    data = (turtle_interfaces__msg__VnUtcTime *)calloc(size, sizeof(turtle_interfaces__msg__VnUtcTime));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = turtle_interfaces__msg__VnUtcTime__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        turtle_interfaces__msg__VnUtcTime__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
turtle_interfaces__msg__VnUtcTime__Sequence__fini(turtle_interfaces__msg__VnUtcTime__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      turtle_interfaces__msg__VnUtcTime__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  turtle_interfaces__msg__VnUtcTime__Sequence * array = (turtle_interfaces__msg__VnUtcTime__Sequence *)malloc(sizeof(turtle_interfaces__msg__VnUtcTime__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = turtle_interfaces__msg__VnUtcTime__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    turtle_interfaces__msg__VnUtcTime__Sequence__fini(array);
  }
  free(array);
}
...
turtle_interfaces__msg__VnUtcTime__Sequence__are_equal(const turtle_interfaces__msg__VnUtcTime__Sequence * lhs, const turtle_interfaces__msg__VnUtcTime__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!turtle_interfaces__msg__VnUtcTime__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  turtle_interfaces__msg__VnUtcTime__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(turtle_interfaces__msg__VnUtcTime);
    turtle_interfaces__msg__VnUtcTime * data =
      (turtle_interfaces__msg__VnUtcTime *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!turtle_interfaces__msg__VnUtcTime__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          turtle_interfaces__msg__VnUtcTime__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!turtle_interfaces__msg__VnUtcTime__copy(
