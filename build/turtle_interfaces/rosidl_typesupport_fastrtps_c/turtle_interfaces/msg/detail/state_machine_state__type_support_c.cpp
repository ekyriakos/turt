...
#include "turtle_interfaces/msg/detail/state_machine_state__rosidl_typesupport_fastrtps_c.h"
...
using _StateMachineState__ros_msg_type = turtle_interfaces__msg__StateMachineState;
...
size_t get_serialized_size_turtle_interfaces__msg__StateMachineState(
  const void * untyped_ros_message,
...
static uint32_t _StateMachineState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_interfaces__msg__StateMachineState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t max_serialized_size_turtle_interfaces__msg__StateMachineState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_turtle_interfaces__msg__StateMachineState(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, msg, StateMachineState)() {
