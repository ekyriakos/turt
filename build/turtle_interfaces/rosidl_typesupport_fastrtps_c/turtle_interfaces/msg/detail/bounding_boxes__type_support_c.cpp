...
#include "turtle_interfaces/msg/detail/bounding_boxes__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // color, h, w, x, y
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // color, h, w, x, y
...
using _BoundingBoxes__ros_msg_type = turtle_interfaces__msg__BoundingBoxes;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: w
  {
    ...
    if (ros_message->w.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->w);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->w, size)) {
      fprintf(stderr, "failed to create array for field 'w'");
      return false;
    }
    auto array_ptr = ros_message->w.data;
    cdr.deserializeArray(array_ptr, size);
  ...
  // Field name: color
  {
    ...
    if (ros_message->color.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->color);
    }
...
size_t get_serialized_size_turtle_interfaces__msg__BoundingBoxes(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BoundingBoxes__ros_msg_type * ros_message = static_cast<const _BoundingBoxes__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BoundingBoxes__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_interfaces__msg__BoundingBoxes(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t max_serialized_size_turtle_interfaces__msg__BoundingBoxes(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_turtle_interfaces__msg__BoundingBoxes(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, msg, BoundingBoxes)() {
