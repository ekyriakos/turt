...
#include "turtle_interfaces/msg/detail/steering__rosidl_typesupport_fastrtps_c.h"
...
using _Steering__ros_msg_type = turtle_interfaces__msg__Steering;
...
size_t get_serialized_size_turtle_interfaces__msg__Steering(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Steering__ros_msg_type * ros_message = static_cast<const _Steering__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Steering__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_interfaces__msg__Steering(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t max_serialized_size_turtle_interfaces__msg__Steering(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_turtle_interfaces__msg__Steering(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, msg, Steering)() {
