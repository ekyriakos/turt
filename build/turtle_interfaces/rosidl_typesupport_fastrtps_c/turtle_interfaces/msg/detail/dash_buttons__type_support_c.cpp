...
#include "turtle_interfaces/msg/detail/dash_buttons__rosidl_typesupport_fastrtps_c.h"
...
using _DashButtons__ros_msg_type = turtle_interfaces__msg__DashButtons;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DashButtons__ros_msg_type * ros_message = static_cast<const _DashButtons__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _DashButtons__ros_msg_type * ros_message = static_cast<_DashButtons__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_turtle_interfaces__msg__DashButtons(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DashButtons__ros_msg_type * ros_message = static_cast<const _DashButtons__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _DashButtons__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_interfaces__msg__DashButtons(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t max_serialized_size_turtle_interfaces__msg__DashButtons(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_turtle_interfaces__msg__DashButtons(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_DashButtons = {
...
static rosidl_message_type_support_t _DashButtons__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DashButtons,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, msg, DashButtons)() {
  return &_DashButtons__type_support;
}
