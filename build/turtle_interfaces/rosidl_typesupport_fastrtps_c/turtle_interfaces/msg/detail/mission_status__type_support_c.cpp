...
#include "turtle_interfaces/msg/detail/mission_status__rosidl_typesupport_fastrtps_c.h"
...
using _MissionStatus__ros_msg_type = turtle_interfaces__msg__MissionStatus;
...
size_t get_serialized_size_turtle_interfaces__msg__MissionStatus(
  const void * untyped_ros_message,
...
static uint32_t _MissionStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_interfaces__msg__MissionStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t max_serialized_size_turtle_interfaces__msg__MissionStatus(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_turtle_interfaces__msg__MissionStatus(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, msg, MissionStatus)() {
