...
bool turtle_interfaces__msg__vn_quat__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtle_interfaces.msg._vn_quat.VnQuat", full_classname_dest, 37) == 0);
  }
  turtle_interfaces__msg__VnQuat * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of VnQuat */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtle_interfaces.msg._vn_quat");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VnQuat");
