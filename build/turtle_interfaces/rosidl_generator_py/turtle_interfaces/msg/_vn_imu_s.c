...
bool turtle_interfaces__msg__vn_imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtle_interfaces.msg._vn_imu.VnImu", full_classname_dest, 35) == 0);
  }
  turtle_interfaces__msg__VnImu * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of VnImu */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtle_interfaces.msg._vn_imu");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VnImu");
