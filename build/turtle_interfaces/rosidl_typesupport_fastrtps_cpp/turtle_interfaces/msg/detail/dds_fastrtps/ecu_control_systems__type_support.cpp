...
#include "turtle_interfaces/msg/detail/ecu_control_systems__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_interfaces::msg::ECUControlSystems & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::msg::ECUControlSystems & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtle_interfaces
max_serialized_size_ECUControlSystems(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::msg::ECUControlSystems *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_interfaces::msg::ECUControlSystems *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ECUControlSystems__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const turtle_interfaces::msg::ECUControlSystems *>(
...
{
  return max_serialized_size_ECUControlSystems(full_bounded, 0);
}

static message_type_support_callbacks_t _ECUControlSystems__callbacks = {
...
static rosidl_message_type_support_t _ECUControlSystems__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ECUControlSystems__callbacks,
...
{
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_ECUControlSystems__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, msg, ECUControlSystems)() {
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_ECUControlSystems__handle;
}
