...
#include "turtle_interfaces/msg/detail/cpu_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_interfaces::msg::CpuStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::msg::CpuStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: core_usage_percents
  {
    ...
    size_t item_size = sizeof(ros_message.core_usage_percents[0]);
  ...
  // Member: node_cpu_usage_percents
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.node_cpu_usage_percents[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: node_cpu_usage_names
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.node_cpu_usage_names[index].size() + 1);
    }
  }
  // Member: number_of_temperatures
  {
  ...
  // Member: core_temperatures
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.core_temperatures[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: core_temperature_names
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.core_temperature_names[index].size() + 1);
    }
  }
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::msg::CpuStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_interfaces::msg::CpuStatus *>(
    untyped_ros_message);
...
{
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_CpuStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, msg, CpuStatus)() {
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_CpuStatus__handle;
}
