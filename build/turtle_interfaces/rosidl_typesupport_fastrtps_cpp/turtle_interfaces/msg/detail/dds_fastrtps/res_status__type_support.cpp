...
#include "turtle_interfaces/msg/detail/res_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_interfaces::msg::ResStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::msg::ResStatus & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::msg::ResStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_interfaces::msg::ResStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ResStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const turtle_interfaces::msg::ResStatus *>(
...
{
  return max_serialized_size_ResStatus(full_bounded, 0);
}

static message_type_support_callbacks_t _ResStatus__callbacks = {
...
static rosidl_message_type_support_t _ResStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ResStatus__callbacks,
...
{
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_ResStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, msg, ResStatus)() {
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_ResStatus__handle;
}
