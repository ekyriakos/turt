...
#include "turtle_interfaces/msg/detail/mission_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_interfaces::msg::MissionStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::msg::MissionStatus & ros_message)
{
  // Member: mission_status
  cdr >> ros_message.mission_status;
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::msg::MissionStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_interfaces::msg::MissionStatus *>(
    untyped_ros_message);
...
{
  return max_serialized_size_MissionStatus(full_bounded, 0);
}
...
get_message_type_support_handle<turtle_interfaces::msg::MissionStatus>()
{
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_MissionStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, msg, MissionStatus)() {
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_MissionStatus__handle;
}
