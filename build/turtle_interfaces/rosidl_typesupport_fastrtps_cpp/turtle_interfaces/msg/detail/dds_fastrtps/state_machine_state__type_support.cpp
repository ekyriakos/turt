...
#include "turtle_interfaces/msg/detail/state_machine_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_interfaces::msg::StateMachineState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: state
  cdr << ros_message.state;
  // Member: setfinished
  cdr << (ros_message.setfinished ? true : false);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::msg::StateMachineState & ros_message)
{
  // Member: state
  cdr >> ros_message.state;
  ...
  // Member: setfinished
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message.setfinished = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: setfinished
  {
    size_t item_size = sizeof(ros_message.setfinished);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::msg::StateMachineState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_interfaces::msg::StateMachineState *>(
    untyped_ros_message);
...
get_message_type_support_handle<turtle_interfaces::msg::StateMachineState>()
{
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_StateMachineState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, msg, StateMachineState)() {
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_StateMachineState__handle;
}
