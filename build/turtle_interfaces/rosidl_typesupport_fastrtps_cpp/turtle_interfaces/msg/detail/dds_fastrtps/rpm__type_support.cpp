...
#include "turtle_interfaces/msg/detail/rpm__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_interfaces::msg::RPM & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::msg::RPM & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::msg::RPM *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_interfaces::msg::RPM *>(
    untyped_ros_message);
...
{
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_RPM__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, msg, RPM)() {
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_RPM__handle;
}
