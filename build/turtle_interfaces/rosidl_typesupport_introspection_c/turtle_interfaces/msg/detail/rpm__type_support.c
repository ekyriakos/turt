...
#include <stddef.h>
#include "turtle_interfaces/msg/detail/rpm__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  turtle_interfaces__msg__RPM__init(message_memory);
}

void RPM__rosidl_typesupport_introspection_c__RPM_fini_function(void * message_memory)
{
  turtle_interfaces__msg__RPM__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember RPM__rosidl_typesupport_introspection_c__RPM_message_member_array[3] = {
  {
    ...
    offsetof(turtle_interfaces__msg__RPM, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtle_interfaces__msg__RPM, left),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtle_interfaces__msg__RPM, right),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers RPM__rosidl_typesupport_introspection_c__RPM_message_members = {
  ...
  "RPM",  // message name
  3,  // number of fields
  sizeof(turtle_interfaces__msg__RPM),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_interfaces, msg, RPM)() {
  RPM__rosidl_typesupport_introspection_c__RPM_message_member_array[0].members_ =
